...
public class PaintSurface extends JComponent {
        ...
        this.addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                if (shapeType == DrawShape.SHAPE_RECTANGLE) {
                    ...
                    shape = new Ellipse();
                } else if (shapeType == DrawShape.SHAPE_LINE){
                    shape = new Line();
                } else if (shapeType == DrawShape.SHAPE_QUADCURVE){
                    shape = new QuadCurve();
                } else {
                    return;
                }
    ...
    public void paint(Graphics g) {
        ...
        shapes.forEach(s -> {
            if( s instanceof Line || s instanceof QuadCurve) {
                // Устанавливаем размер рамки фигуры в 7 пикселя
                g2.setStroke(new BasicStroke(8));
                // Устанавливаем цвет линий
                g2.setPaint(colors.get(shapes.indexOf(s) % 6));
            } else {
                // Устанавливаем размер рамки фигуры в 2 пикселя
    ...
    public void clear() {
        ...
        List<DrawShape> tmp = new ArrayList<>();
        shapes = tmp;
        repaint();
    }
}